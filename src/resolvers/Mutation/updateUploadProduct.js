 ...
 * @return {Promise<Object>} updateUploadProduct payload
 */
export default async function updateUploadProduct(_, { input }, context) {
    const {
    ...
    const updatedProduct = await context.mutations.updateUploadProduct(context, {
        product: productInput,
